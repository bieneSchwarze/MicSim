...
# ----------------------------------------------------------------------------------------------------------------------
# ----------------------------------------------------------------------------------------------------------------------
  micSimLink_old <- function(initPop, immigrPop=NULL, transitionMatrix, absStates=NULL, fixInitStates = c(),
  ...
  codingScheme <- builtStatesCodes(transitionMatrix) #this is where codingscheme comes from
  ...
  # Function adds to simulation population a newborn (using sim. step without duration dep. trans. functions)  #this i don't get yet
  ...
  # entered its current state `currState'. At this, consider possible duration dependencies of transition rates.#what exactly does this mean? duration dependencies?
